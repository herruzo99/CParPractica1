...
do
echo "Fase $(($i))"
../evolution 200 25 1000 1000 1 10 $((4424+$i*127)) 6534 2461 $(($i*19059 % 4000 +1)) | sed --expression='$!d' >testsNew/Seed1Test$i; diff -q testBaseNew/Seed1Test$i testsNew/Seed1Test$i 
../evolution 30 30 1500 1000 1 7 4624 $((9334+$i*7)) 961 10 | sed --expression='$!d' >testsNew/Seed2Test$i; diff -q testBaseNew/Seed1Test$i testsNew/Seed1Test$i
../evolution 40 10 200 1000 1 2 4468 57764 $((2461+$i*13)) $(($i*4741 % 40 +1)) | sed --expression='$!d' >testsNew/Seed3Test$i; diff -q testBaseNew/Seed1Test$i testsNew/Seed1Test$i
../evolution 200 10 100 1000 2 4 $((44+$i*37)) 55534 $((9361+$i*56)) 100  | sed --expression='$!d' >testsNew/Seed13Test$i; diff -q testBaseNew/Seed1Test$i testsNew/Seed1Test$i
../evolution 5 500 75 1000 1 11 $((4324+$i*8)) $((576+$i*3)) $((461+$i*11)) $(($i*742 % 80 +1)) | sed --expression='$!d' >testsNew/Seed123Test$i; diff -q testBaseNew/Seed1Test$i testsNew/Seed1Test$i
done
